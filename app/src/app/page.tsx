  ...
  const daoFlow = [
    {
      ...
      description:
        "Regenerative businesses submit proposals detailing their impact, funding needs, and milestones.",
    },
    {
      title: "Community Review",
      description:
        "DAO members review, discuss, and provide feedback on submitted projects.",
    },
    {
      title: "Quadratic Voting",
      description:
        "Members allocate votes using a quadratic formula that rewards broader community support.",
    },
    {
      title: "Transparent Funding",
      description:
        "Approved projects receive funding through smart contracts with predefined milestones.",
    },
    {
      title: "Impact Tracking",
      description:
        "Projects provide regular updates, and the community monitors progress and impact.",
    },
  ];
